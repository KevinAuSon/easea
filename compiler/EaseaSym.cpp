	...
	while((pSym=pSymbolList->walkToNextItem()))
	{
		...
		else
		{
			...
			else if(pSym->Object->ObjectType==oPointer && strcmp(pSym->Object->pType->sName, "GPNode") == 0)
			{
				...
				fprintf(fpOutputFile,"\t if( currentNode->getFirstChild() != NULL ) nodesToVisit.push_back( currentNode->getFirstChild() ); \n");
				fprintf(fpOutputFile,"\t if( currentNode->getBrother() != NULL ) nodesToVisit.push_back( currentNode->getBrother() ); \n");
				...
				fprintf(fpOutputFile,"\t if( currentNode->getFirstChild() != NULL )                                            \n");
				fprintf(fpOutputFile,"\t  EASEA_Line << indexes[ currentNode->getFirstChild() ] << \" \";                 \n");
				fprintf(fpOutputFile,"\t else                                                                              \n");
				fprintf(fpOutputFile,"\t  EASEA_Line << \"0 \";                                                       \n");
				fprintf(fpOutputFile,"\t                                                                                  \n");
				fprintf(fpOutputFile,"\t if( currentNode->getBrother() != NULL )                                            \n");
				fprintf(fpOutputFile,"\t  EASEA_Line << indexes[ currentNode->getBrother() ] << \" \";                 \n");
				fprintf(fpOutputFile,"\t else             \n");
				fprintf(fpOutputFile,"\t  EASEA_Line << \"0 \";                                                       \n");
				fprintf(fpOutputFile,"\t                 \n");
	...
	while ((pSym=pSymbolList->walkToNextItem())){
		...
		else
		{
			...
			if(pSym->Object->ObjectType==oPointer && strcmp(pSym->Object->pType->sName, "GPNode") == 0)
			{
				...
				fprintf(fpOutputFile, "\t if( nodeMap[n].second[0] != 0 ) nodeMap[n].first->setFirstChild(nodeMap[ nodeMap[n].second[0] ].first); \n");
				fprintf(fpOutputFile, "\t if( nodeMap[n].second[1] != 0 ) nodeMap[n].first->setBrother(nodeMap[ nodeMap[n].second[1] ].first); \n");
				fprintf(fpOutputFile, "\t\n");	
